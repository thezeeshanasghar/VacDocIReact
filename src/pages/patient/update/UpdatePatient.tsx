...
const UpdatePatient: React.FC = () => {
  ...
  const [preferredDayOfReminder, setPreferredDayOfReminder] = useState("0");
  ...
  const handleCancel = () => {
    // Reset form data or handle cancellation here
    setName("");
    setFatherName("");
    setEmail("");
    setDOB("");
    ...
    <IonPage>
      <IonContent>
        <form noValidate>
          ...
          <IonItem>
            <IonLabel>Preferred Day of Reminder</IonLabel>
            <IonSelect
